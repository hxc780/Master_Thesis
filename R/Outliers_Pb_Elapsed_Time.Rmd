...
#data_26$Pb_DIV_Ca[684:749] <- data_26$Pb_DIV_Ca[683] + 
#  ((1:66) / 67) * (data_26$Pb_DIV_Ca[750] - data_26$Pb_DIV_Ca[683])
...
# Exporting
write.csv(data_137, "data_137_NEW.csv", row.names = FALSE)
```
...
```{r}
data_164$Pb_DIV_Ca[1147:1150] <- data_164$Pb_DIV_Ca[1145] + 
  ((1:4) / 5) * (data_164$Pb_DIV_Ca[1145] - data_164$Pb_DIV_Ca[1151])

data_164$Pb_DIV_Ca[461]    <- (data_164$Pb_DIV_Ca[460] + data_164$Pb_DIV_Ca[462]) / 2
data_164$Pb_DIV_Ca[1118]    <- (data_164$Pb_DIV_Ca[1117] + data_164$Pb_DIV_Ca[1119]) / 2
...
#fjerner alt over 0.00005
data_164 <- data_164[data_164$Pb_DIV_Ca <= 0.00005, ]
...
data_188 <- data_188[data_188$Pb_DIV_Ca <= 0.000025, ]
...
data_210127 <- data_210127[-c(1255:1280),]
...
# data_210161 <- data_210161[data_210161$Pb_DIV_Ca <= 0.000005, ]
